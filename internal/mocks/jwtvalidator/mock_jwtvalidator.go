...
func (m *MockIJWTValidator) ValidateJWTRaw(arg0 string) (jwt.Token, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateJWTRaw", arg0)
...
func (mr *MockIJWTValidatorMockRecorder) ValidateJWTRaw(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateJWTRaw", reflect.TypeOf((*MockIJWTValidator)(nil).ValidateJWTRaw), arg0)
}
